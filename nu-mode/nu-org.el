...
(defun nu-prepare-org-mode-internal ()
  ...
  (define-key nu-change-map (kbd "C") 'org-clock-in)
  (define-key nu-change-map (kbd "D") 'org-decrease-number-at-point)
  (define-key nu-change-map (kbd "E") 'org-emphasize)
  (define-key nu-change-map (kbd "F") 'org-table-create-or-convert-from-region)
  (define-key nu-change-map (kbd "G") 'org-ctrl-c-star)
  (define-key nu-change-map (kbd "H") 'org-toggle-checkbox)
  ...
  (define-key nu-change-map (kbd "O") 'org-clock-out)
  (define-key nu-change-map (kbd "P") 'org-priority)
  ...
  (define-key nu-kill-map (kbd "I") 'org-delete-indentation)
  ...
  ;; GOTO
  (define-key nu-goto-map (kbd "A") 'org-clock-goto)
  ...
  (define-key nu-mark-map (kbd "X") 'org-next-link)
  (define-key nu-mark-map (kbd "V") 'org-previous-link)
  ...
  (define-key nu-insert-map (kbd "I") 'org-timer)
  (define-key nu-insert-map (kbd "U") 'org-columns-insert-dblock)
  ...
  (define-key nu-open-map (kbd "C") 'org-clock-report)
  ...
  (define-key nu-quit-map (kbd "B") 'org-archive-subtree-default)
  (define-key nu-quit-map (kbd "C") 'org-archive-to-archive-sibling)
  (define-key nu-quit-map (kbd "D") 'org-clock-cancel)
  (define-key nu-quit-map (kbd "E") 'org-remove-file)
  ...
  (define-key nu-save-map (kbd "R") 'org-mark-ring-push)
