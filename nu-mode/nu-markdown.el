...
(defun nu-prepare-markdown-mode-internal ()
   ...
   ;; DISPLAY PROMPT
   (define-key nu-display-map (kbd "A") 'markdown-check-change-for-wiki-link)
   (define-key nu-display-map (kbd "B") 'markdown-narrow-to-block)
   (define-key nu-display-map (kbd "C") 'markdown-cycle)
   (define-key nu-display-map (kbd "D") 'markdown-hide-body)
   (define-key nu-display-map (kbd "E") 'markdown-hide-sublevels)
   (define-key nu-display-map (kbd "F") 'markdown-hide-subtree)
   ...
   (define-key nu-mark-map (kbd "P") 'markdown-mark-page)
   (define-key nu-mark-map (kbd "G") 'markdown-mark-paragraph)
   (define-key nu-mark-map (kbd "T") 'markdown-mark-text-block)

   ;; GOTO MAP
   (define-key nu-goto-map (kbd "A") 'markdown-backward-block)
   (define-key nu-goto-map (kbd "B") 'markdown-backward-page)
   (define-key nu-goto-map (kbd "C") 'markdown-backward-paragraph)
   (define-key nu-goto-map (kbd "D") 'markdown-do)
   (define-key nu-goto-map (kbd "E") 'markdown-beginning-of-list)
   (define-key nu-goto-map (kbd "F") 'markdown-follow-thing-at-point)
   (define-key nu-goto-map (kbd "G") 'markdown-forward-block)
   (define-key nu-goto-map (kbd "H") 'markdown-follow-link-at-point)
   (define-key nu-goto-map (kbd "I") 'markdown-backward-same-level)
   (define-key nu-goto-map (kbd "J") 'markdown-beginning-of-text-block)
