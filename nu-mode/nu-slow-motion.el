...
(defun nu-slow-motion-set-keys-a-la-emacs ()
  "substitute to evil keys emacs like keybinding, but modal"
   ...
   (define-key evil-normal-state-map "k" nil) ; find-car
   (define-key evil-normal-state-map "K" nil) ; find-car
   ...
   (define-key evil-normal-state-map "Q" 'evil-change-whole-line)
   ...
   (define-key evil-normal-state-map "Z" 'evil-replace-state)
