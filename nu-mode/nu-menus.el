...
(defun nu-populate-bold-map ()
 "Populate bold map"
  ...
  (define-key nu-bold-map "a" 'align)
  (define-key nu-bold-map "c" 'capitalize-word)
  (define-key nu-bold-map "d" 'downcase-word)
  (define-key nu-bold-map "e" 'facemenu-face-menu)
  (define-key nu-bold-map "f" 'fill-paragraph)
  (define-key nu-bold-map "i" 'indent)
  (define-key nu-bold-map "n" 'set-fill-column)
  (define-key nu-bold-map "o" 'indent-for-comment)
  (define-key nu-bold-map "r" 'set-fill-prefix)
  (define-key nu-bold-map "s" 'indent-sexp)
  (define-key nu-bold-map "u" 'upcase-word))
...
(defun nu-populate-save-map ()
 "Populate save map	.	"
  ...
  (define-key nu-save-map "s" 'save-buffer)
...
(defun nu-populate-find-map ()
  ...
  (define-key nu-find-map "g" 'rgrep)
...
(defun nu-populate-replace ()
  ...
  (define-key nu-replace-map "R" 'nu-toggle-read-only)
